            ...
            <box className="bluetooth-device" onDestroy={deviceCleanup}>
                    ...
                    <box vertical spacing={5} hexpand>
                        ...
                        <box spacing={10}>
                            {device?.connected && (
                                <label
                                    label="Connected"
                                    className="status-label connected"
                                />
                            )}
                            {device?.paired && (
                                <label
                                    label="Paired"
                                    className="status-label paired"
                                />
                            )}
                            {device?.trusted && (
                                <label
                                    label="Trusted"
                                    className="status-label trusted"
                                />
                            )}
                            {device?.battery_percentage >= 0 && (
                                <label
                                    label={`${device.battery_percentage}%`}
                                    className="status-label battery"
                                />
                            )}
                        </box>
                    </box>
                ...
                <box spacing={5} halign={Gtk.Align.END}>
                    ...
                    <button
                        ...
                        tooltipText={
                            device?.paired ? "Already paired" : "Pair device"
                        }
                        cursor={"hand1"}
                    >
                    ...
                    <button
                        ...
                        onClicked={
                            device?.connected ? handleDisconnect : handleConnect
                        }
                        tooltipText={
                        ...
                        <box spacing={10} className="battery-charging-button">
                            <box hexpand vertical spacing={5}>
                                ...
                                <label
                                    label={bind(chargeMode).as((mode) =>
                                        mode === "preserve"
                                            ? "Increases battery longevity by maintaining lower charge levels (80% max)"
