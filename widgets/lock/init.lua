...
local music = require("widgets.lock.mods.music")
local bat = require("widgets.lock.mods.battery")
local weather = require("widgets.lock.mods.weather")
...
local makeImage = function()
	local cmd = "convert " .. beautiful.lock .. " -filter Gaussian -blur 0x6 ~/.cache/awesome/lock.jpg &"
