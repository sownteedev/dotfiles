...
Popup {
    ...
    focus: true
    height: placementParent ? Responsive.fitWithMargins(400, placementParent.height, 8, 260) : parent ? Responsive.fitWithMargins(400, parent.height, 8, 260) : 400
    modal: true
    padding: 0
    parent: Overlay.overlay

    // ─── Geometry & style ──────────────────────────────────────────────────────
    width: placementParent ? Responsive.fitWithMargins(300, placementParent.width, 8, 220) : parent ? Responsive.fitWithMargins(300, parent.width, 8, 220) : 300
