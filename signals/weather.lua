...
awful.widget.watch(string.format(GET_FORECAST_CMD, url), 43200, function(_, stdout, stderr)
...
awful.widget.watch(string.format(GET_FORECAST_CMD, url1), 43200, function(_, stdout, stderr)
	local result = json.decode(stdout)
