//! Allocation-conscious JSON encoding for the QML stream protocol.

use super::model::{ProcessMemoryDetails, RankedProcess, StatsPayload};
use std::fmt::Write;
...
#[cfg(test)]
mod tests {
    use super::super::model::ProcessMemoryDetails;
