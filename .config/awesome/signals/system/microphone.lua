...
local function get_mute()
	awful.spawn.easy_async_with_shell("pamixer --source 59 --get-mute", function(value)
...
function update_value_of_mic()
	awful.spawn.easy_async_with_shell("pamixer --source 59 --get-volume", function(stdout)
